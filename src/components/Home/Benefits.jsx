...
const Benefits = () => {
  ...
  return (
      <div className='p-[5%] pt-[10%] lg:px-[8rem] bg-nude font-primary'>
        <div className='bg-nude1 flex flex-col md:flex-row'>
          ...
          <div className='md:w-1/2 bg-brown3 text-nude flex flex-col items-center justify-center px-8 lg:px-12 py-32 space-y-5'>
            ...
            <h1 className='text-2xl md:text-4xl capitalize font-secondary font-thin'>
              fits your skin
            </h1>
            <p className='lg:w-[80%] md:text-xl xl:text-3xl '>
            ...
            <a href='/shop' 
            className='text-lg xl:text-3xl px-4 md:px-6 py-2 flex items-center border-2 border-nude hover:bg-nude hover:text-brown3 hover:-translate-y-4 duration-300 transition-all cursor-pointer'>
              Shop now
