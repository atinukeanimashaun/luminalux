...
const About = () => {
  return (
    <div className='p-[5%] lg:px-[6rem] 2xl:px-[20rem] bg-nude text-brown1'>
      <div className='flex flex-col md:flex-row gap-7'>
        <div className='md:w-1/2'>
          <p className='text-xl 2xl:text-2xl font-primary pb-3'>About us</p>
          <h1 className='text-4xl md:text-4xl 2xl:text-7xl font-secondary w-4/5'>Luminalux facial and skincare company</h1>
        </div>
        <div className='md:w-1/2 pt-6'>
          <p className='text-xl 2xl:text-3xl leading-snug'>
          ...
          <p className='text-xl 2xl:text-3xl leading-snug pt-6'>
