...
const Hero = () => {
  ...
  return (
    < div className='pt-[25%] md:pt-[10%] pb-[5%] px-3 lg:px-[8rem] bg-gradient-to-r from-brown from-0% to-nude1 to-100% font-primary'> 
      <div className='flex flex-col md:flex-row justify-between items-center gap-7'>
        <div className='md:w-1/2 space-y-7 px-5'>
          <h1 className='text-brown1 text-4xl md:text-5xl lg:text-7xl font-secondary font-thin'>
          ...
          <a href='/shop'
          className='bg-nude text-brown1 text-lg 2xl:text-3xl w-[50%] lg:w-[40%] p-2 flex items-center hover:bg-brown1 hover:text-nude hover:-translate-y-4 duration-300 transition-all cursor-pointer'>
            Shop now
